    ...
    <div class="flex-align gap-16">
        ...
        <form action="#" class="w-350 d-sm-block d-none">
            <div class="position-relative">
                ...
                <input type="text" class="form-control ps-40 h-40 border-transparent focus-border-main-600 bg-main-50 rounded-pill placeholder-15" placeholder="Search..." spellcheck="false" data-ms-editor="true">
            </div>
        </form>
    </div>
    ...
    <div class="flex-align gap-16">
        ...
        <div class="dropdown">
            <button class="users arrow-down-icon border border-gray-200 rounded-pill p-4 d-inline-block pe-40 position-relative" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                <span class="position-relative">
                    <img src="https://ui-avatars.com/api/?name={{ urlencode($user->name) }}&background=random&length=2" alt="Image" class="h-32 w-32 rounded-circle">
                ...
                <div class="card border border-gray-100 rounded-12 box-shadow-custom">
                    <div class="card-body">
                        <div class="flex-align gap-8 mb-20 pb-20 border-bottom border-gray-100">
                            <img src="https://ui-avatars.com/api/?name={{ urlencode($user->name) }}&background=random&length=2" alt="" class="w-54 h-54 rounded-circle">
                            <div class="">
                        ...
                        <ul class="max-h-270 overflow-y-auto scroll-sm pe-4">
                            ...
                            <li class="pt-8 border-top border-gray-100">
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <button type="submit" class="w-100 text-start py-12 text-15 px-20 hover-bg-danger-50 text-gray-300 hover-text-danger-600 rounded-8 d-flex align-items-center gap-8 fw-medium text-15 border-0 bg-transparent">
